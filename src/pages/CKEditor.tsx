 ...
 * https://ckeditor.com/ckeditor-5/builder/?redirect=portal#installation/NoRgNARATAdAnDADBSIAcUBsaDsa0iZ5Q4DMALDoojiIuaY3ZlCOZdgKw6chyKks1ZJACmAOxSIwoMOGnh5AXUhR+AEzgBDNBCVA
 */
...
const CLOUD_SERVICES_TOKEN_URL =
  "https://vlct5wp73zjk.cke-cs.com/token/dev/199ad012d1821777840875f3b4db3114f56f0b62fec040c804352dee056c?limit=10";
const CLOUD_SERVICES_WEBSOCKET_URL = "wss://vlct5wp73zjk.cke-cs.com/ws";
const GPL_KEY = "GPL";
...
export default function CKEditorPage() {
  ...
  const editRef = useRef<ClassicEditor | null>(null);
